...
;;notes here:
;; let's add
;; - Enable line number in command mode only
;; - when in transient mode (after SPC) make window numbers overlay for more visibility
;;
...
you should place your code here."
  ...
  ;;;; lsp::Typescript
  ;;typescript-mode-hook TODO using ts-ls for now
  ...
  ;; experimenting with some Info mode nav
  (define-key Info-mode-map (kbd "D") 'scroll-up-line)
  (define-key Info-mode-map (kbd "U") 'scroll-down-line)
  ;; org-mode stuff
  (setq-default org-startup-indented 't)
  (setq-default org-pretty-entities 't)
  (setq-default org-log-done 'time)
  (setq org-agenda-files (file-expand-wildcards (concat "~/WorkDocs/Agenda" "/*.org")))
  (setq-default org-startup-with-inline-images 't)
  ;; (define-key org-mode-map (kbd "t") 'org-todo)
  (evil-define-key 'normal org-mode-map (kbd "t") 'org-todo)
  (spacemacs/set-leader-keys "oc" 'org-toggle-checkbox)
  ...
  ;; more eshell/dired nav stuff
  (spacemacs/set-leader-keys "ee" 'eshell)
  ;; TODO (spacemacs/set-leader-keys "tt" 'ansi-term) ;; but with a pinned window. Maybe I could name it
