...
Trying to fix the height thing:
#+BEGIN_SRC emacs-lisp
...
behavior
- Note that this only copies $PATH and $MANPATH, which is interesting. See `exec-path-from-shell-variables`
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package org-roam
    ...
    (setq org-roam-directory
          (file-truename (concat (getenv "HOME") "/Dropbox/Local/Org/org-roam"))) ;; use gpg file extension to force encryption
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key window-map (kbd "FD") #'delete-frame)
#+END_SRC
...
**** <2024-08-03>
Funnily, now that I'm a more common dired user, this feels like a bad idea. I've grown to really like the lightweight feeling of the dired buffer.
